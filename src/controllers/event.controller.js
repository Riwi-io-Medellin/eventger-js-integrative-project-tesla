...
const {notifyUsersEmail, notifyUsersPhone, createNotification} = require("../services/notification.service.js")
...
async function create(req, res, next) {
    ...
    try {
        ...
        const emailNotification = await notifyUsersEmail(response[0])

        //Send Whatsapp notification
        const phoneNotification = await notifyUsersPhone(response[0])

        //Create Notification
        console.log(response[0])
        const notification= await createNotification(response[0].id)
