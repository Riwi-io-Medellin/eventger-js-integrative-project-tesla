...
const NAV_ITEMS = [
  { label: 'Muro',        page: 'muro',      href: '#/',           icon: ICONS.muro,      roles: ['admin_gen','admin_spa','event_creator','visualizer'] },
  { label: 'Dashboard',   page: 'dashboard', href: '#/dashboard',  icon: ICONS.dashboard, roles: ['admin_spa','event_creator','visualizer'] },
  { label: 'Usuarios',    page: 'users',     href: '#/usuarios',   icon: ICONS.users,     roles: ['admin_gen'] },
  { label: 'Eventos',     page: 'events',    href: '#/eventos',    icon: ICONS.events,    roles: ['admin_spa','event_creator'] },
  { label: 'Espacios',    page: 'spaces',    href: '#/espacios',   icon: ICONS.spaces,    roles: ['admin_spa'] },
  { label: 'Escenarios',  page: 'complex',   href: '#/escenarios', icon: null,            roles: ['admin_spa'], sub: true },
  { label: 'Mi Perfil',   page: 'profile',   href: '#/perfil',     icon: ICONS.profile,   roles: ['admin_gen','admin_spa','event_creator','visualizer'] },
];
...
export function buildSidebar(activePage = '') {
  ...
  const links = visible.map((item) => {
    ...
    if (item.sub) {
      return `
    <a class="nav-item${isActive ? ' active' : ''}" href="${item.href}" data-link
